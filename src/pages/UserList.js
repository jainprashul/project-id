...
import { IonHeader, IonPage, IonToolbar, IonTitle, IonContent, IonList, IonItem, IonLabel, useIonViewWillEnter, IonAvatar, IonFab, IonFabButton, IonIcon, IonLoading } from '@ionic/react'
...
const UserList = (props) => {
    ...
    const getFaces = async () => {
        ...
        const key = '71d8405657a9a3edb62424bb48b0cfaad7d11c4e68eac6a44d99f0f0f4523201'
        ...
        await db.allDocs({ include_docs: true, descending: true , attachments: true  }, (err, doc) =>{
...

                    {
                        Faces.length ?
                            (Faces.map((item, i) => {
                                ...
                                return(
                            <IonItem key={i} href={`/dashboard/users/${i}`} onClick={() => {
